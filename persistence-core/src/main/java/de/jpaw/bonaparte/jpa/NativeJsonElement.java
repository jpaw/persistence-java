 ...
 *
 */
public final class NativeJsonElement implements Serializable {
    private static final long serialVersionUID = 6234763103220203029L;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        NativeJsonElement other = (NativeJsonElement) obj;
        if (data == null) {
            if (other.data != null)
                return false;
